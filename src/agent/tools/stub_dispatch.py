...
Intentional stubs only (mcp_tool: null). Real MCP collect tools must NOT appear here.
"""
...
# Note: douyin_collect_hot_keywords is requires_mcp / platform_mcp — never stubbed.
